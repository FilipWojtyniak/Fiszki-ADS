...
const questions = [
  // Wykład 5: Dyskretne urządzenia czujnikowe
  {
    ...
    answers: [
      ...
      {
        text: "sporządzanie planu produkcji na podstawie zamówień klientów",
        correct: true,
      },
  ...
  },
  {
    ...
    answers: [
      {
        text: "stanowiska robocze, np. montażowe na których realizowany jest proces",
        correct: true,
      },
      {
        text: "zbiór operacji technologicznych danego procesu",
        correct: false,
      },
      {
        text: "kompleks środków (energia, materiały, ludzie i maszyny) produkcyjnych",
        correct: false,
      },
  ...
  },
  {
    ...
    answers: [
      ...
      {
        text: "uwzględniają także krytyczne parametry oprzyrządowania",
        correct: true,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: "zespół czujników współpracujących z przetwornikami",
        correct: true,
      },
  ...
  },
  {
    ...
    answers: [
      {
        text: "zbierania informacji o położeniu członów manipulatora",
        correct: false,
      },
      { text: "obróbki informacji z sensorów wizyjnych", correct: false },
      {
        text: "przetwarzania sygnałów analogowych na kodowane",
        correct: false,
      },
      {
        text: "przekształcania informacji akustycznej na sygnał dźwiękowy",
        correct: false,
      },
    ],
  },
  {
    ...
    answers: [
      {
        text: "dwukrotnie większej rozdzielczości niż naturalny kod dwójkowy",
        correct: true,
      },
      {
        text: "takiej samej rozdzielczości niż naturalny kod dwójkowy",
        correct: false,
      },
      { text: "większej rozdzielczości niż kod BCD", correct: false },
      {
        text: "dwukrotnie mniejszej rozdzielczości niż naturalny kod dwójkowy",
        correct: false,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: "rejestracji przypadkowych sygnałów zakłócających",
        correct: false,
      },
  ...
  },
  {
    ...
    answers: [
      ...
      {
        text: "stanowią sprzężenie zwrotne w układzie automatyki",
        correct: false,
      },
      {
        text: "generowane są w układach blokad i sygnalizacji",
        correct: false,
      },
  ...
  },
  {
    ...
    answers: [
      ...
      {
        text: "mają możliwość rejestracji wartości sygnałów sterujących",
        correct: false,
      },
      { text: "zawierają sensory do oceny warunków otoczenia", correct: false },
      {
        text: "umożliwiają dokonywanie zmian parametrów urządzeń wykonawczych",
        correct: false,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: "można zatrzymać (zahamować) w dowolnej pozycji",
        correct: false,
      },
  ...
  },
  {
    ...
    lecture: "Wykład 6: Dyskretne urządzenia wykonawcze",
    question:
      "Do prezentacji sygnałów wyjściowych układu automatyki stosuje się:",
    answers: [
  ...
  // Wykład 7: Problemy automatyzacji wybranych procesów
  {
    ...
    answers: [
      ...
      {
        text: "harmonogramowaniu realizacji poszczególnych etapów pracy",
        correct: false,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        text: "nakłady kapitałowe poniesione na budowę systemu automatyki",
        correct: true,
      },
  ...
  },
  {
    ...
    answers: [
      {
        text: "dotyczy przydzielania urządzeniom transportowym poszczególnych zadań",
        correct: true,
      },
      { text: "zawiera bieżące sterowanie komputerowe", correct: false },
      {
        text: "umożliwia budowę modelu symulacyjnego systemu transportowego",
        correct: false,
      },
  ...
  },
  {
    ...
    answers: [
      ...
      {
        text: "sygnalizacji i raportowania o aktualnej sytuacji",
        correct: true,
      },
  ...
  },
  {
    ...
    answers: [
      {
        text: "charakteryzować się dużą wydajnością przeładunkową",
        correct: true,
      },
      { text: "skrócić czas oczekiwania statków w portach", correct: true },
      {
        text: "umożliwić obsługę kontenerów o różnych wymiarach",
        correct: true,
      },
      {
        text: "zapewnić niezależną obsługę systemów czujnikowych",
        correct: false,
      },
    ],
  },
  ...
  },
  {
    id: 27,
    lecture: "Wykład 7: Problemy automatyzacji wybranych procesów",
    question: "W agentowym systemie generowania sekwencji montażowej jest:",
    answers: [
      { text: "stosowany tajny agent", correct: false },
      { text: "używany system rozpoznawania agenta", correct: false },
      { text: "zawarty układ generatora funkcyjnego", correct: false },
      { text: "generowany agent systemowy", correct: false },
    ],
  },
];
